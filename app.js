...
const mapPositions = {
  ...
  'bld-007': { x: 40, y: 60 }, // السلط التقنية

  'bld-008': { x: 45, y: 65 }, // الذكاء الاصطناعي
  'bld-009': { x: 58, y: 58 }, // الاتصالات وتكنولوجيا المعلومات
  'bld-010': { x: 20, y: 15 }, // رئاسة الجامعة
  'bld-011': { x: 24, y: 18 }, // الأمانة العامة
  'bld-012': { x: 30, y: 22 }, // كلية التخطيط والادارة
  'bld-013': { x: 18, y: 55 }, // المشاغل الهندسية
  'bld-014': { x: 48, y: 48 }, // مجمع القاعات التدريسية
  'bld-015': { x: 62, y: 52 }, // كفتيريا الطلبة
  'bld-016': { x: 55, y: 44 }, // مركز الحاسوب
  'bld-017': { x: 68, y: 28 }, // صالة الضيافة
  'bld-018': { x: 38, y: 62 }, // إدارة كلية السلط
  'bld-019': { x: 42, y: 68 }, // مبنى ب
  'bld-020': { x: 50, y: 72 }, // الأكاديمية الإلكترونية
  'bld-021': { x: 36, y: 66 }, // مبنى أ
  'bld-022': { x: 70, y: 60 }, // المبنى التجاري
  'bld-023': { x: 80, y: 70 }, // الصالة الرياضية
  'bld-024': { x: 26, y: 58 }, // مختبرات
  'bld-025': { x: 64, y: 46 }, // قاعة الندوات
  'bld-026': { x: 85, y: 35 }, // الزراعة التكنولوجية
  'bld-027': { x: 57, y: 63 }, // مدخل كلية الأمير عبدالله
  'bld-028': { x: 47, y: 32 }, // مبنى العمادة
  'bld-029': { x: 22, y: 72 }, // الخدمات العامة
  'bld-030': { x: 25, y: 76 }, // ملحق خدمات
  'bld-031': { x: 90, y: 12 }, // مهبط الطائرات
  'bld-032': { x: 10, y: 90 }, // البوابة الرئيسية
  'bld-033': { x: 18, y: 12 }, // مدخل الرئاسة
  'bld-034': { x: 32, y: 18 }, // مدخل كلية التخطيط
  'bld-035': { x: 15, y: 78 }, // مدخل اللوازم
  'bld-036': { x: 72, y: 18 }, // المسجد
  'bld-037': { x: 50, y: 50 }, // صرح الجامعة
  'bld-038': { x: 40, y: 24 }, // مركز الجودة
  'bld-039': { x: 12, y: 84 }, // الأمن الجامعي
  'bld-040': { x: 54, y: 74 }, // مبنى الاكاديمية
  'bld-041': { x: 16, y: 68 }, // قسم الحركة
  'bld-042': { x: 88, y: 22 }, // كلية الطب
  'bld-043': { x: 92, y: 30 } // الدفاع المدني
};
const manualRoutes = {
