...
const mapPositions = {
  ...
  'bld-007': { x: 12.3, y: 42.1  }, // السلط التقنية
  'bld-008': { x: 10.3, y: 35.1 }, // الذكاء الاصطناعي
  'bld-009': { x: 36.8, y: 70.0 }, // الاتصالات وتكنولوجيا المعلومات
  'bld-014': { x: 48, y: 48 }, // مجمع القاعات التدريسية
  'bld-015': { x: 62, y: 45 }, // كفتيريا الطلبة
  'bld-026': { x: 40.8, y: 27.9 }, // الزراعة التكنولوجية
  'bld-032': { x: 85, y: 52 }, // البوابة الرئيسية
  'bld-036': { x: 52.4, y: 20.2 }, // المسجد
  'bld-040': { x: 85, y: 35 }, // مبنى الاكاديمية
  'bld-042': { x: 40.8, y: 65.0 }, // كلية الطب
};
const manualRoutes = {
